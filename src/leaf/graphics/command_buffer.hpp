...
namespace lf {
	namespace CommandBuffer {
		...
		void ClearColor(view<command_buffer> command_buffer, u32 color_index, f32 r, f32 g, f32 b,
						f32 a);
		...
		void UseGraphicsProgram(view<command_buffer> command_buffer,
								view<graphics_program> program);
		void SetScissor(view<command_buffer> command_buffer, u32 x, u32 y, u32 width, u32 height);
		void UseComputeProgram(view<command_buffer> command_buffer, view<compute_program> program);
		void UniformBuffer(view<command_buffer> command_buffer, uniform_location location,
						   view<buffer> buffer, u64 offset, u64 size);
		void UniformTexture(view<command_buffer> command_buffer, uniform_location location,
							view<texture_view> texture_view);
		void StorageBuffer(view<command_buffer> command_buffer, u32 binding, view<buffer> buffer,
						   u64 offset, u64 size);
		void StorageTexture(view<command_buffer> command_buffer, u32 binding,
							view<texture_view> texture_view);
		void ComputeBarrier(view<command_buffer> command_buffer);
		...
		void Dispatch(view<command_buffer> command_buffer, u32 group_count_x, u32 group_count_y,
					  u32 group_count_z);
