...
namespace lf {
	template <typename kT, typename vT, typename Hasher = std::hash<kT>,
			  typename KeyEqual = std::equal_to<kT>>
	...
	using unordered_map_string =
		unordered_map<string, T, transparent_string_view_hash, transparent_string_view_equal>;
} // namespace lf